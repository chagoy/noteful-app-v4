...
describe('Noteful api - login', function() {
    ...
    describe('noteful api/login', function() {
        ...
        it('should reject requests with empty username', function() {
            return chai.request(app)
                .post('/api/login')
                .send({ username: '', password })
                .then(res => {
        ...
        it('should reject requests with empty password', function() {
            return chai.request(app)
                .post('/api/login')
                .send({ username, password: '' })
                .then(res => {
        ...
        it('should reject requests with incorrect username', function() {
            return chai.request(app)
                .post('/api/login')
                .send({ username: 'notarealname', password: 'password'})
                .then(res => {
    ...
    describe('/api/refresh', function() {
        ...
        it('should return a valid auth token if new expiration date', function () {
